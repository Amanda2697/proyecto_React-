...
import './Seccion_cultura.css'
import CulturaImagen from '../../assets/imagenes/culturaimag.jpg';
import SeccionImag from '../seccionImag/SeccionImag';

import SUIZACULTURA1 from '../../assets/imagenes/SCulture4.webp';
import SUIZACULTURA2 from '../../assets/imagenes/SCulture1.jpg';
import SUIZACULTURA3 from '../../assets/imagenes/SCulture2.jpg';
import SUIZACULTURA4 from '../../assets/imagenes/SUIZACULTURA.jpg';
import SIDEBARADD from '../../assets/imagenes/SideBarADD.png';
import Menu from '../menu/Menu';

function Seccion_cultura() {
  ...
  return (
    <>
      <SeccionImag imageSrc={CulturaImagen} text="Cultura" />
      <Menu />
...
export default Seccion_cultura;
